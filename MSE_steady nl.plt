...
set key right top font "Arial,8"
set size ratio 0.75
set grid
...
plot [0:3] \
    ...
    'output/parfeval_SteadyStateMSE_errorbar(N=200, S1=2, T=5000, mu=0.1, ens=1000, xi=0).txt' using 1:2:($2-sqrt($3)):($2+sqrt($3)) with yerrorbars linetype 4 pt 7 ps 0.5 title "S1=2"
